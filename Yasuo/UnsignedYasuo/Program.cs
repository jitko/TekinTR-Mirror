...
namespace UnsignedYasuo
{
    internal class Program
    {
        ...
        private static void Game_OnTick(EventArgs args)
        {
            ...
            {
                Chat.Print("Guzel Penta!Devamini bekliyorum!");
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (menu.GetCheckboxValue("Goster Q") && !Yasuo.HasBuff("YasuoQ3W") && Q.IsLearned)
            {
            ...
            if (menu.GetCheckboxValue("Goster W") && W.IsLearned)
                W.DrawRange(drawColor);
            if (menu.GetCheckboxValue("Goster E") && E.IsLearned)
                E.DrawRange(drawColor);
            if (menu.GetCheckboxValue("Goster EQ") && E.IsLearned && Q.IsLearned)
                EQ.DrawRange(drawColor);
            if (menu.GetCheckboxValue("Goster R") && R.IsLearned)
                R.DrawRange(drawColor); 
            if (menu.GetCheckboxValue("Goster Beyblade") && R.IsLearned && Flash != null && E.IsLearned && Q.IsLearned)
                Drawing.DrawCircle(Yasuo.Position, E.Range + Flash.Range + (EQ.Range / 2), System.Drawing.Color.Red);
            if (menu.GetCheckboxValue("Goster Kule Menzili"))
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
            ...
            if (MenuHandler.Drawing.GetCheckboxValue("Goster Combo Hasari"))
