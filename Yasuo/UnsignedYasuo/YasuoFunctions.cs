...
namespace UnsignedYasuo
{
    class YasuoFunctions
    {
        ...
        public static void LastHit()
        {
            ...
            bool EUnderTower = menu.GetCheckboxValue("Kullan E Kule alti");

            if ((menu.GetCheckboxValue("Kullan Q") && !Yasuo.HasBuff("YasuoQ3W"))
                || (menu.GetCheckboxValue("Kullan Q3") && Yasuo.HasBuff("YasuoQ3W")))
                CastQ(enemies, true);

            if (menu.GetCheckboxValue("Kullan E"))
                CastE(enemies, true, EUnderTower);

            if (menu.GetCheckboxValue("Kullan EQ"))
        ...
        public static void LaneClear()
        {
            ...
            if (menu.GetCheckboxValue("Kullan E"))
            {
                if (menu.GetCheckboxValue("Kullan E sadece son vurus"))
                    CastE(enemies, true, EUnderTower);
                else
        ...
        public static void KS()
        {
            ...
            bool EUnderTower = menu.GetCheckboxValue("Kullan E Kullan Kule alti");
        ...
        public static void Harrass()
        {
            ...
            if ((menu.GetCheckboxValue("Kullan Q") && !Yasuo.HasBuff("YasuoQ3W") && menu.GetCheckboxValue("Use Q to Last Hit Minions"))
                || (menu.GetCheckboxValue("Kullan Q3") && Yasuo.HasBuff("YasuoQ3W") && menu.GetCheckboxValue("Use Q3 to Last Hit Minions")))
        ...
        public static void Combo()
        {
            ...
            if (menu.GetComboBoxText("Dash Mode: ") == "To Mouse")
                EToMouse(EUnderTower,
                    false, menu.GetCheckboxValue("Kullan EQ"), enemies);
        ...
        public static void Flee()
        {
            ...
            if (menu.GetCheckboxValue("Kullan E") || activeDash != null)
            {
                if (activeDash == null)
                {
                    Orbwalker.MoveTo(Game.CursorPos);
                    EToMouse(menu.GetCheckboxValue("Kullan E Kule alti"), menu.GetCheckboxValue("Stack Q"), false);
                }
                else
                {
        ...
        public static void UltHandler()
        {
            ...
            if (MenuHandler.Ult.GetCheckboxValue("Kullan R akis icin") &&
                Yasuo.Mana != 100)
                CastR();

            if (MenuHandler.Ult.GetCheckboxValue("Menzildeki Tüm Düsmanlarda R kullanin") &&
            ...
            if (MenuHandler.Ult.GetCheckboxValue("Hedef Secicinin Hedefi uzerinde R kullan") &&
        ...
        public static void CastR(bool force = false)
        {
            ...
            if (!force && MenuHandler.GetCheckboxValue(MenuHandler.Ult, "Son Saniyede R kullanin") &&
                timeTilLastEnemyIsPutDown <= 0.1f)
                    didActionThisTick = Program.R.Cast();
            else if (force || !MenuHandler.GetCheckboxValue(MenuHandler.Ult, "Son Saniyede R kullanin"))
                    didActionThisTick = Program.R.Cast();;
        }
