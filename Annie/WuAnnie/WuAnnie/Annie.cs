...
namespace WuAIO
{
    class Annie : HeroBase
    {
        ...
        public override void CreateMenu()
        {
            ...
            {
                menu.NewCheckbox("disable", "Kapali", false);
                menu.NewCheckbox("damageindicator", "Verilicek hasar");
                menu.NewCheckbox("q/w/r", "Q/W/R");
                menu.NewCheckbox("flash+r", "Sicra + R");
            ...
            menu = MenuManager.AddSubMenu("Combo");
            {
                ...
                menu.NewCheckbox("r.jiws", "Sadece R sersemlicekse");
                menu.NewSlider("r.minenemies", "En az dusman R", 2, 1, 5, true);
            }
            ...
            menu = MenuManager.AddSubMenu("Lane Clear");
            {
                ...
                menu.NewSlider("q.mode", "Q Modu, 0 : Surekli, 1 : Dusman yoksa surekli, 2 : Stan yoksa surekli", 1, 0, 2);
                menu.NewCheckbox("w", "W", true, true);
                menu.NewSlider("w.minminions", "En az minyon W", 3, 1, 7);
            ...
            {
                menu.NewCheckbox("q", "Q");
                menu.NewSlider("q.mode", "Q Modu, 0 : Surekli, 1 : Dusman yoksa surekli, 2 : Stan yoksa surekli", 0, 0, 2);
            }
            ...
            menu = MenuManager.AddSubMenu("Misc");
            {
                ...
                menu.NewCheckbox("stackstun", "Yuk kas");
                menu.NewCheckbox("interrupter", "Interrupter");
                menu.NewCheckbox("gapcloser", "Atılma Yapanlara oto stun");
                menu.NewKeybind("autor", "Oto R hedefe (Min düşman sayısını yoksay):", false, KeyBind.BindTypes.HoldActive, 'J', true);
                menu.NewKeybind("autoflash+r", "Oto Sicra + R (Min düşman sayısını yok saymaz):", false, KeyBind.BindTypes.HoldActive, 'J', true);
            }
        }
