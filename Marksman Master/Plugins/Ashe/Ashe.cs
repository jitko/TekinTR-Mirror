...
namespace Marksman_Master.Plugins.Ashe
{
    internal class Ashe : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Ashe.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Volley (W) settings :");
            ComboMenu.Add("Plugins.Ashe.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Hawkshot (E) settings :");
            ComboMenu.Add("Plugins.Ashe.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Enchanted Crystal Arrow (R) settings :");
            ComboMenu.Add("Plugins.Ashe.ComboMenu.UseR", new CheckBox("Kullan R"));
            ComboMenu.Add("Plugins.Ashe.ComboMenu.RMinimumRange", new Slider("R kullanmak icin en kisa mesefe", 350, 100, 700));
            ComboMenu.Add("Plugins.Ashe.ComboMenu.RMaximumRange", new Slider("R kullanmak icin en uzak mesefe", 2500, 700, 3000));
            ComboMenu.AddSeparator(5);
            ...
            HarassMenu.Add("Plugins.Ashe.HarassMenu.UseW", new CheckBox("Kullan W"));
            HarassMenu.Add("Plugins.Ashe.HarassMenu.MinManaForW", new Slider("En az mana ({0}%) to use W", 60, 1));
            ...
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.UseQInLaneClear", new CheckBox("Kullan Q koridor temizlemede"));
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.UseQInJungleClear", new CheckBox("Kullan Q orman temizlemede"));
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.MinManaQ", new Slider("En az mana ({0}%) Q icin", 50, 1));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Volley (W) settings :");
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.UseWInLaneClear", new CheckBox("Kullan W koridor temizlemede"));
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.UseWInJungleClear", new CheckBox("Kullan W orman temizlemede"));
            LaneClearMenu.Add("Plugins.Ashe.LaneClearMenu.MinManaW", new Slider("En az mana ({0}%) W icin", 80, 1));
            ...
            MiscMenu.Add("Plugins.Ashe.MiscMenu.MaxInterrupterRange",
                new Slider("En fazla uzaklik dusmani R ile kesmek icin", 1500, 0, 2500));
            ...
            DrawingsMenu.Add("Plugins.Ashe.DrawingsMenu.DrawSpellRangesWhenReady",
                new CheckBox("Hazir olan buyuleri goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.Add("Plugins.Ashe.DrawingsMenu.DrawW", new CheckBox("Goster W "));
            DrawingsMenu.Add("Plugins.Ashe.DrawingsMenu.DrawWColor",
                new CheckBox("Rengi sec", false)).OnValueChange += (a, b) => {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Ashe.DrawingsMenu.DrawR", new CheckBox("Goster R "));
