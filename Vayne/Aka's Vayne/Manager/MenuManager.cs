...
namespace Aka_s_Vayne.Manager
{
    class MenuManager
    {
        ...
        private static void Combomenu()
        {
            ...
            ComboMenu.Add("UseEKill", new CheckBox("Olucekse E ?"));
            ComboMenu.AddGroupLabel("R Ayari");
        ...
        public static void QSettings()
        {
            ...
            Qsettings.Add("UseMirinQ", new CheckBox("Atis modu"));
            Qsettings.Add("UseQE", new CheckBox("Dene QE?", false));
            //smart
            Qsettings.Add("UseSafeQ", new CheckBox("Dinamik Q Güvenligi?", false)).IsVisible = true;
            Qsettings.Add("UseQEnemies", new CheckBox("Dusmana Q kullanma?", false)).IsVisible = true;
            Qsettings.Add("UseQSpam", new CheckBox("Engelleri yoksay", false)).IsVisible = true;
            //new
            Qsettings.Add("QNMode", new ComboBox("Yeni Mod", 1, "Yan", "Guvenli Pozisyon")).IsVisible = false;
            Qsettings.Add("QNEnemies", new Slider("X düsman yaninda Q engelle", 3, 5, 0)).IsVisible = false;
            Qsettings.Add("QNWall", new CheckBox("Duvar yaninda engelle Q", true)).IsVisible = false;
            Qsettings.Add("QNTurret", new CheckBox("Kule altinda Q engelle", true)).IsVisible = false;
        }
        ...
        public static void Condemnmenu()
        {
            ...
            CondemnMenu.Add("Condemnmode", new ComboBox("Condemn E Modu", 4, "Best", "Old", "Marksman", "Shine", "ACV"));
            CondemnMenu.Add("UseEAuto", new CheckBox("Otomatik E"));
            CondemnMenu.Add("UseETarget", new CheckBox("Sadece hedefi stanla", false));
            CondemnMenu.Add("UseEHitchance", new Slider("E tutma sansi", 2, 1, 4));
            ...
            CondemnMenu.Add("AutoTrinket", new CheckBox("Otomatik totem kullan?"));
            CondemnMenu.Add("J4Flag", new CheckBox("E kullan J4 ulti attiginda?"));
        }
        ...
        private static void Miscmenu()
        {
            ...
            MiscMenu.Add("GapcloseQ", new CheckBox("Ani yaklasmada Q"));
            MiscMenu.Add("GapcloseE", new CheckBox("Ani yaklasmada E"));
            MiscMenu.Add("InterruptE", new CheckBox("Kesmek E"));
            MiscMenu.Add("LowLifeE", new CheckBox("Canim azalinca E", false));
        ...
        private static void Drawingmenu()
        {
            ...
            DrawingMenu.Add("DrawOnlyReady", new CheckBox("Hazir olan buyuleri goster"));
            ...
            DrawingMenu.Add("DrawAutoPos", new CheckBox("Goster AutoPos"));
        }
