...
namespace UnsignedCamille
{
    class ModeManager
    {
        ...
        public static void Flee()
        {
            ...
            if (menu.GetCheckboxValue("Kullan E1") && Program.E.IsReady() && Program.E.Name == "CamilleE" && Game.Time - LastECheckTime > 0.25f)
            {
            ...
            else if (menu.GetCheckboxValue("Kullan E2") && Program.E.IsReady() && Program.E.Name == "CamilleEDash2" && Game.Time - LastECheckTime > 0.1)
            {
                Vector2 closestToCursorPos = Vector2.Zero;
                float closestToCursorPosDistance = Camille.Distance(Game.CursorPos);
